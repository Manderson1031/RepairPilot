...
const PREVIEW_REPAIRS=[{id:'preview-repair',equipment_name:'Husqvarna Riding Mower',fix:'Cleaned restricted carburetor passage',symptom:'Engine surges with no load'}];
...
export default function App(){
 ...
 const FeatureTile=({icon,title,sub,onPress,badge}:{icon:any,title:string,sub:string,onPress:()=>void,badge?:string})=><TouchableOpacity style={s.featureTile} onPress={onPress}><View style={s.featureIconBox}><MaterialCommunityIcons name={icon} size={27} color="#ffb000"/></View>{badge?<Text style={s.newBadge}>{badge}</Text>:null}<Text style={s.featureTitle}>{title}</Text><Text style={s.featureSub}>{sub}</Text></TouchableOpacity>;
...
,
 topBar:{height:54,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:8,borderBottomWidth:1,borderBottomColor:'rgba(255,176,0,.55)',backgroundColor:'rgba(7,9,10,.98)'},wordmarkRow:{flexDirection:'row',alignItems:'center',gap:6},wordmarkIcon:{width:29,height:29,borderRadius:15},topBrand:{color:'#f5f5f2',fontSize:18,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',fontStyle:'italic',letterSpacing:.8},topIcon:{color:'#e9e9e5',fontSize:21,minWidth:24,textAlign:'center'},topHit:{width:38,height:38,alignItems:'center',justifyContent:'center'},previewBar:{backgroundColor:'rgba(8,10,11,.98)',zIndex:20,borderBottomWidth:1,borderBottomColor:'rgba(255,176,0,.38)'},previewBarTitle:{height:18,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:4},previewBarText:{color:'#c88b00',fontSize:7,fontWeight:'900',letterSpacing:.55},previewPicker:{position:'absolute',top:18,left:8,right:8,backgroundColor:'#111415',borderWidth:1,borderColor:'#ffb000',padding:5,flexDirection:'row',flexWrap:'wrap',gap:4,shadowColor:'#000',shadowOpacity:.8,shadowRadius:12,shadowOffset:{width:0,height:6}},previewChoice:{width:'49.3%',paddingVertical:10,paddingHorizontal:10,borderWidth:1,borderColor:'#3d4345',backgroundColor:'#191c1d'},previewChoiceActive:{backgroundColor:'#ffb000',borderColor:'#ffd05a'},previewChoiceText:{color:'#e8e9e6',fontSize:11,fontWeight:'800'},previewChoiceTextActive:{color:'#15110a'},bottomNav:{height:58,flexDirection:'row',borderTopWidth:1,borderTopColor:'#3f4446',backgroundColor:'rgba(7,9,10,.99)',paddingBottom:3},navItem:{flex:1,alignItems:'center',justifyContent:'center'},navIcon:{color:'#8c9295',fontSize:18},navLabel:{color:'#858b8d',fontSize:7.5,marginTop:2,fontWeight:'800'},navActive:{color:'#ffb000'},
 ...
 dashboardWrap:{paddingHorizontal:12,paddingTop:8,paddingBottom:70},welcomeBlock:{paddingHorizontal:2,paddingBottom:8,borderBottomWidth:1,borderBottomColor:'rgba(255,176,0,.34)'},welcomeSmall:{color:'#d6d7d5',fontSize:10},welcomeName:{color:'#fff',fontSize:23,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900'},welcomeSub:{color:'#9ba0a2',fontSize:10,marginTop:0},sectionHeader:{flexDirection:'row',alignItems:'center',gap:8,marginTop:10,marginBottom:6},sectionTitle:{color:'#ffb000',fontSize:12,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',letterSpacing:.55},sectionRail:{height:1,flex:1,backgroundColor:'rgba(255,176,0,.34)',borderRightWidth:24,borderRightColor:'rgba(112,116,116,.28)'},featureGrid:{flexDirection:'row',flexWrap:'wrap',gap:5},featureTile:{width:'32.35%',minHeight:96,borderWidth:1,borderColor:'rgba(142,147,149,.62)',borderRadius:3,backgroundColor:'rgba(12,14,15,.98)',paddingHorizontal:3,paddingVertical:7,alignItems:'center',justifyContent:'center',position:'relative',shadowColor:'#ffb000',shadowOpacity:.07,shadowRadius:4},featureIconBox:{width:33,height:28,alignItems:'center',justifyContent:'center',marginBottom:3},featureIconText:{color:'#ffb300',fontSize:25,fontWeight:'700'},featureTitle:{color:'#f5f5f2',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontWeight:'900',fontSize:9.5,textAlign:'center',letterSpacing:.15},featureSub:{color:'#9ea3a5',fontSize:7.5,lineHeight:10,textAlign:'center',marginTop:3},newBadge:{position:'absolute',right:4,top:4,backgroundColor:'#ffb000',color:'#111',fontWeight:'900',fontSize:6.5,paddingHorizontal:4,paddingVertical:2,borderRadius:2},activityRow:{borderWidth:1,borderColor:'#555b5d',borderRadius:3,backgroundColor:'rgba(14,16,17,.98)',paddingHorizontal:12,paddingVertical:9,flexDirection:'row',justifyContent:'space-between',alignItems:'center'},activityTitle:{color:'#f4f4f0',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontSize:14,fontWeight:'900'},chevron:{color:'#ffb000',fontSize:25,marginLeft:8},logoutLink:{padding:12,alignItems:'center'},
