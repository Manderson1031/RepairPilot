...
export default function App(){
 ...
 const GearBackdrop=()=> <ImageBackground source={require('../assets/industrial-bg-v34.png')} resizeMode="cover" style={s.gearLayer} imageStyle={s.bgImage}><View style={s.bgShade}/><View style={s.steelTop}/><View style={s.hazardRail}/><View style={[s.bolt,{top:22,left:18}]}/><View style={[s.bolt,{top:22,right:18}]}/></ImageBackground>;
 ...
 if(screen==='home')return <SafeAreaView style={s.safe}><StatusBar style="light"/><GearBackdrop/><TopBar/><ScrollView contentContainerStyle={s.dashboardWrap}>
  ...
  <SectionHeader>QUICK ACTIONS</SectionHeader><View style={s.featureGrid}>
   ...
   <FeatureTile icon="lightning-bolt" title="HARDWARE SCANNER" sub="Identify hardware & find parts" badge="NEW" onPress={()=>nav('scanner')}/>
   <FeatureTile icon="cube-scan" title="AR REPAIR ASSISTANT" sub="Visual guidance in real world" onPress={()=>nav('ar')}/>
   <FeatureTile icon="excavator" title="MY EQUIPMENT" sub="Manage your equipment" onPress={async()=>{await loadEquipment();nav('equipment')}}/>
   <FeatureTile icon="clipboard-text-clock-outline" title="MY DIAGNOSTICS" sub="View past diagnostics" onPress={loadHistory}/>
   <FeatureTile icon="tools" title="MAINTENANCE" sub="Schedules & reminders" onPress={()=>nav('maintenance')}/>
  </View>
...
const s=StyleSheet.create({
 ...
 gearLayer:{...StyleSheet.absoluteFill,overflow:'hidden',backgroundColor:'#07090a'},bgImage:{opacity:.72},bgShade:{...StyleSheet.absoluteFill,backgroundColor:'rgba(3,4,5,.20)'},gear:{position:'absolute',color:'rgba(123,128,130,.13)',fontWeight:'400',textShadowColor:'rgba(255,179,0,.12)',textShadowRadius:16},amberGlow:{position:'absolute',borderRadius:999,backgroundColor:'rgba(255,153,0,.10)'},steelTop:{position:'absolute',left:0,right:0,top:0,height:92,backgroundColor:'rgba(9,11,12,.70)',borderBottomColor:'rgba(255,179,0,.38)',borderBottomWidth:1},hazardRail:{position:'absolute',left:0,right:0,bottom:0,height:8,backgroundColor:'#c88700',opacity:.55},bolt:{position:'absolute',width:8,height:8,borderRadius:4,backgroundColor:'#73787a',borderWidth:1,borderColor:'#151719'},meshLine:{position:'absolute',left:20,right:20,top:92,height:1,backgroundColor:'rgba(255,179,0,.18)'},
...
,
 topBar:{height:66,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:10,borderBottomWidth:1,borderBottomColor:'rgba(214,143,0,.70)',backgroundColor:'rgba(5,7,8,.91)'},wordmarkRow:{flexDirection:'row',alignItems:'center',gap:5},wordmarkIcon:{display:'none',width:0,height:0},topBrand:{color:'#ececea',fontSize:30,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',fontStyle:'italic',letterSpacing:-.7,textShadowColor:'rgba(0,0,0,.95)',textShadowRadius:3},topIcon:{color:'#e4e4df',fontSize:25,minWidth:28,textAlign:'center'},topHit:{width:44,height:44,alignItems:'center',justifyContent:'center'},previewBar:{height:0,zIndex:20},previewBarTitle:{height:0,overflow:'hidden',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:4},previewBarText:{color:'#c88b00',fontSize:7,fontWeight:'900',letterSpacing:.55},previewPicker:{position:'absolute',top:0,left:8,right:8,backgroundColor:'#111415',borderWidth:1,borderColor:'#ffb000',padding:5,flexDirection:'row',flexWrap:'wrap',gap:4,shadowColor:'#000',shadowOpacity:.8,shadowRadius:12,shadowOffset:{width:0,height:6}},previewChoice:{width:'49.3%',paddingVertical:10,paddingHorizontal:10,borderWidth:1,borderColor:'#3d4345',backgroundColor:'#191c1d'},previewChoiceActive:{backgroundColor:'#ffb000',borderColor:'#ffd05a'},previewChoiceText:{color:'#e8e9e6',fontSize:11,fontWeight:'800'},previewChoiceTextActive:{color:'#15110a'},bottomNav:{height:72,flexDirection:'row',borderTopWidth:1,borderTopColor:'rgba(184,121,0,.42)',backgroundColor:'rgba(5,7,8,.94)',paddingBottom:5},navItem:{flex:1,alignItems:'center',justifyContent:'center'},navIcon:{color:'#8c9295',fontSize:22},navLabel:{color:'#8f9394',fontSize:10,marginTop:3,fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontWeight:'800'},navActive:{color:'#ffb000'},
 ...
 dashboardWrap:{paddingHorizontal:12,paddingTop:8,paddingBottom:84},welcomeBlock:{minHeight:146,paddingHorizontal:8,paddingTop:16,paddingBottom:18,borderBottomWidth:0,justifyContent:'center'},welcomeSmall:{color:'#d0d1cf',fontSize:16,fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),textShadowColor:'rgba(0,0,0,.95)',textShadowRadius:3},welcomeName:{color:'#f2f2ef',fontSize:35,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',letterSpacing:.2,textShadowColor:'rgba(0,0,0,.95)',textShadowRadius:4},welcomeSub:{color:'#c0c2c1',fontSize:15,marginTop:2,fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),textShadowColor:'rgba(0,0,0,.95)',textShadowRadius:3},sectionHeader:{flexDirection:'row',alignItems:'center',gap:10,marginTop:11,marginBottom:9,paddingHorizontal:2},sectionTitle:{color:'#f2a900',fontSize:18,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',letterSpacing:.25,textShadowColor:'rgba(0,0,0,.9)',textShadowRadius:2},sectionRail:{height:1,flex:1,backgroundColor:'rgba(222,149,0,.62)'},featureGrid:{flexDirection:'row',flexWrap:'wrap',gap:7},featureTile:{width:'32%',minHeight:174,borderWidth:1,borderColor:'rgba(181,120,13,.82)',borderRadius:4,backgroundColor:'rgba(11,13,14,.84)',paddingHorizontal:6,paddingVertical:12,alignItems:'center',justifyContent:'center',position:'relative',shadowColor:'#000',shadowOpacity:.32,shadowRadius:5,shadowOffset:{width:0,height:3}},featureIconBox:{width:52,height:50,alignItems:'center',justifyContent:'center',marginBottom:9},featureIconText:{color:'#f5aa00',fontSize:42,fontWeight:'700'},featureTitle:{color:'#efefec',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontWeight:'900',fontSize:14.5,lineHeight:17,textAlign:'center',letterSpacing:.05,textShadowColor:'rgba(0,0,0,.9)',textShadowRadius:2},featureSub:{color:'#c0c2c2',fontFamily:Platform.select({ios:'AvenirNextCondensed-Medium',android:'sans-serif-condensed'}),fontSize:12,lineHeight:15.5,textAlign:'center',marginTop:7},newBadge:{position:'absolute',right:5,top:5,backgroundColor:'#f4aa00',color:'#111',fontWeight:'900',fontSize:10,paddingHorizontal:6,paddingVertical:3,borderRadius:10},activityRow:{borderWidth:1,borderColor:'#555b5d',borderRadius:3,backgroundColor:'rgba(14,16,17,.98)',paddingHorizontal:12,paddingVertical:9,flexDirection:'row',justifyContent:'space-between',alignItems:'center'},activityTitle:{color:'#f4f4f0',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontSize:14,fontWeight:'900'},activityHeader:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:17,marginBottom:8,paddingHorizontal:2},viewAll:{color:'#f0a800',fontSize:12,fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900'},recentRow:{minHeight:64,flexDirection:'row',alignItems:'center',gap:10,borderWidth:1,borderColor:'rgba(74,80,82,.88)',borderRadius:4,backgroundColor:'rgba(10,13,14,.88)',paddingHorizontal:10,paddingVertical:8,marginBottom:4},historyRow:{minHeight:64,flexDirection:'row',alignItems:'center',gap:10,borderWidth:1,borderColor:'#3e4446',backgroundColor:'rgba(12,15,16,.94)',paddingHorizontal:10,paddingVertical:8,marginBottom:5},historyIcon:{width:38,alignItems:'center'},recentInfo:{flex:1},recentTitle:{color:'#efefec',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontSize:15,fontWeight:'900',textShadowColor:'rgba(0,0,0,.9)',textShadowRadius:2},recentSub:{color:'#adb0b0',fontFamily:Platform.select({ios:'AvenirNextCondensed-Medium',android:'sans-serif-condensed'}),fontSize:11,marginTop:1},recentStatus:{alignItems:'flex-end'},completed:{color:'#75d552',fontSize:11,fontWeight:'900'},inProgress:{color:'#55b8e8',fontSize:11,fontWeight:'900'},recentDate:{color:'#b1b3b2',fontSize:10,marginTop:2},chevron:{color:'#ffb000',fontSize:25,marginLeft:8},logoutLink:{padding:12,alignItems:'center'},
 searchRow:{flexDirection:'row',gap:7},searchInput:{flex:1,backgroundColor:'rgba(16,18,19,.98)',borderWidth:1,borderColor:'#565b5e',borderRadius:3,paddingHorizontal:11,paddingVertical:8,color:'#fff'},filterButton:{width:42,borderWidth:1,borderColor:'#ffb000',borderRadius:3,alignItems:'center',justifyContent:'center'},filterText:{color:'#ffb000',fontSize:25},addPanel:{borderWidth:1,borderColor:'#3b4144',backgroundColor:'rgba(12,15,16,.95)',borderRadius:4,padding:11,marginTop:9},listMeta:{flexDirection:'row',justifyContent:'space-between',marginTop:8,marginBottom:5,paddingHorizontal:2},metaText:{color:'#8c9295',fontSize:8.5,fontWeight:'800',letterSpacing:.5},equipmentRow:{flexDirection:'row',alignItems:'center',gap:9,borderBottomWidth:1,borderBottomColor:'#303537',paddingVertical:10},equipmentCard:{flexDirection:'row',alignItems:'center',gap:9,borderWidth:1,borderColor:'#4a4f51',borderLeftWidth:2,borderLeftColor:'#a97600',backgroundColor:'rgba(13,15,16,.99)',borderRadius:3,padding:7,marginBottom:5},equipmentInfo:{flex:1},equipmentName:{color:'#f5f5f2',fontFamily:Platform.select({ios:'AvenirNextCondensed-DemiBold',android:'sans-serif-condensed'}),fontWeight:'900',fontSize:14.5},equipmentModel:{color:'#a6abad',fontSize:9.5,marginTop:1},equipmentChevron:{color:'#ffb300',fontSize:27,paddingLeft:5},machineThumb:{width:60,height:50,borderRadius:3,borderWidth:1,borderColor:'#596063',backgroundColor:'#171b1c',alignItems:'center',justifyContent:'center',overflow:'hidden'},thumbGlow:{position:'absolute',width:54,height:32,borderRadius:27,backgroundColor:'rgba(255,176,0,.07)'},machineIcon:{fontSize:27,color:'#9da2a4'},serialText:{color:'#747b7e',fontSize:7.5,marginTop:2},categoryBadge:{alignSelf:'flex-start',borderWidth:1,borderColor:'#a97600',backgroundColor:'rgba(44,34,8,.76)',paddingHorizontal:6,paddingVertical:1,borderRadius:2,marginTop:3,maxWidth:110},categoryText:{color:'#ffc027',fontSize:6.5,fontWeight:'900'},selectedMachine:{flexDirection:'row',gap:9,alignItems:'center',borderWidth:1,borderColor:'#454b4d',borderTopColor:'#a97600',backgroundColor:'rgba(13,16,17,.98)',padding:8,marginBottom:10},stepper:{flexDirection:'row',alignItems:'center',paddingHorizontal:16},step:{width:26,height:26,borderRadius:13,borderWidth:1,borderColor:'#5c6264',alignItems:'center',justifyContent:'center',backgroundColor:'#111415'},stepActive:{width:26,height:26,borderRadius:13,alignItems:'center',justifyContent:'center',backgroundColor:'#ffb000'},stepNumber:{color:'#ddd',fontSize:11},stepNumberActive:{color:'#111',fontSize:11,fontWeight:'900'},stepLine:{height:1,backgroundColor:'#51575a',flex:1},stepLabels:{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:2,marginTop:4,marginBottom:9},stepLabel:{color:'#8c9295',fontSize:8,width:'25%',textAlign:'center'},stepLabelActive:{color:'#ffb000',fontSize:8,fontWeight:'900',width:'25%',textAlign:'center'},diagnosisKicker:{color:'#ffb000',fontFamily:Platform.select({ios:'AvenirNextCondensed-Heavy',android:'sans-serif-condensed'}),fontWeight:'900',fontSize:12,letterSpacing:.5,marginBottom:1},diagnosisHint:{color:'#8f9698',fontSize:9,marginBottom:7},symptomGrid:{borderWidth:1,borderColor:'#3e4446',borderRadius:3,overflow:'hidden',marginBottom:7},symptomChoice:{height:36,flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:8,backgroundColor:'rgba(13,16,17,.98)',borderBottomWidth:1,borderBottomColor:'#303537'},symptomChoiceActive:{backgroundColor:'rgba(51,39,9,.96)'},symptomIcon:{width:23,alignItems:'center'},symptomChoiceText:{flex:1,color:'#e8e9e6',fontSize:10.5,fontWeight:'700'},symptomChoiceTextActive:{color:'#15110a',fontWeight:'900'},attachmentRow:{flexDirection:'row',gap:5,marginBottom:7},attachmentButton:{flex:1,minHeight:46,borderWidth:1,borderColor:'#555b5d',borderRadius:3,backgroundColor:'rgba(18,20,21,.98)',alignItems:'center',justifyContent:'center',padding:4},attachmentText:{color:'#e5e6e3',fontSize:7.5,fontWeight:'800',marginTop:2,textAlign:'center'},
 scanTabs:{flexDirection:'row',gap:5,marginBottom:12},scanTab:{flex:1,borderWidth:1,borderColor:'#444a4d',backgroundColor:'rgba(15,18,19,.96)',paddingVertical:10,borderRadius:5,alignItems:'center'},scanTabActive:{backgroundColor:'#ffb300',borderColor:'#ffd05a'},scanTabText:{color:'#d7d9d9',fontSize:9,fontWeight:'900'},scanTabTextActive:{color:'#111'},scannerFrame:{height:420,borderWidth:1,borderColor:'#a97700',backgroundColor:'rgba(8,11,12,.94)',borderRadius:7,overflow:'hidden',alignItems:'center',justifyContent:'center',position:'relative'},scannerImage:{...StyleSheet.absoluteFill,width:'100%',height:'100%'},scanGrid:{...StyleSheet.absoluteFill,opacity:.14,borderWidth:1,borderColor:'#667'},scanReady:{position:'absolute',top:16,color:'#6dff62',borderWidth:1,borderColor:'#23801f',paddingHorizontal:8,paddingVertical:3,fontSize:10,fontWeight:'900'},scanTarget:{color:'#d7d9d9',fontSize:160,opacity:.55},corner:{position:'absolute',width:36,height:36,borderColor:'#fff'},cTL:{left:22,top:58,borderLeftWidth:3,borderTopWidth:3},cTR:{right:22,top:58,borderRightWidth:3,borderTopWidth:3},cBL:{left:22,bottom:28,borderLeftWidth:3,borderBottomWidth:3},cBR:{right:22,bottom:28,borderRightWidth:3,borderBottomWidth:3},scanHelp:{color:'#e3e3df',textAlign:'center',lineHeight:19,marginVertical:15},scanControls:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},scanSide:{width:82,height:72,borderWidth:1,borderColor:'#3e4446',backgroundColor:'rgba(16,19,20,.96)',borderRadius:7,alignItems:'center',justifyContent:'center'},scanSideIcon:{color:'#f3f3ef',fontSize:22},scanSideText:{color:'#f3f3ef',fontSize:8,fontWeight:'900',textAlign:'center'},shutter:{width:78,height:78,borderRadius:39,borderWidth:4,borderColor:'#ffb300',alignItems:'center',justifyContent:'center'},shutterInner:{width:60,height:60,borderRadius:30,backgroundColor:'#ffb300',borderWidth:2,borderColor:'#ffd05a'},devNotice:{borderWidth:1,borderColor:'#4a5052',backgroundColor:'rgba(14,17,18,.96)',borderRadius:4,padding:12,marginTop:12},heroTool:{borderWidth:1,borderColor:'#a97700',backgroundColor:'rgba(14,17,18,.96)',padding:22,borderRadius:8,alignItems:'center'},heroToolIcon:{color:'#ffb300',fontSize:56,fontWeight:'900'},heroToolTitle:{color:'#ffb300',fontSize:18,fontWeight:'900',marginTop:8,textAlign:'center'},heroToolText:{color:'#c4c8c9',fontSize:13,lineHeight:20,textAlign:'center',marginTop:8},arRow:{flexDirection:'row',alignItems:'center',gap:12,borderBottomWidth:1,borderBottomColor:'#33383a',paddingVertical:14},arNum:{width:34,height:34,borderRadius:17,backgroundColor:'#ffb300',alignItems:'center',justifyContent:'center'},arCamera:{height:390,borderWidth:1,borderColor:'#a97700',backgroundColor:'#080b0c',borderRadius:4,overflow:'hidden',position:'relative',alignItems:'center',justifyContent:'center'},arGrid:{...StyleSheet.absoluteFill,backgroundColor:'rgba(29,35,36,.72)',borderWidth:1,borderColor:'#343a3c'},arFocus:{alignItems:'center',justifyContent:'center'},arReady:{color:'#7dff68',fontSize:9,fontWeight:'900',marginTop:5,borderWidth:1,borderColor:'#317c2e',paddingHorizontal:8,paddingVertical:3},arStepCard:{position:'absolute',left:16,right:16,top:16,borderWidth:1,borderColor:'#555b5d',backgroundColor:'rgba(7,9,10,.88)',padding:9},arStepKicker:{color:'#ffb000',fontSize:8,fontWeight:'900'},arStepText:{color:'#f0f1ee',fontSize:11,marginTop:3},arControls:{flexDirection:'row',alignItems:'center',gap:7,marginTop:8},arControl:{width:64,height:52,borderWidth:1,borderColor:'#454b4d',backgroundColor:'#111415',alignItems:'center',justifyContent:'center'},arPrimary:{flex:1,height:52,backgroundColor:'#ffb000',flexDirection:'row',gap:7,alignItems:'center',justifyContent:'center'},arPrimaryText:{color:'#111',fontWeight:'900',fontSize:11},featureSubLeft:{color:'#a3a8aa',fontSize:10,lineHeight:14,marginTop:3},emptyIndustrial:{borderWidth:1,borderColor:'#444a4d',backgroundColor:'rgba(14,17,18,.96)',borderRadius:8,padding:28,alignItems:'center'},profileCard:{flexDirection:'row',gap:14,borderWidth:1,borderColor:'#555b5d',backgroundColor:'rgba(14,16,17,.98)',borderRadius:7,padding:16,marginBottom:10},profileIcon:{width:52,height:52,alignItems:'center',justifyContent:'center'},profileIconText:{color:'#ffb300',fontSize:39},profileTitle:{color:'#ffb300',fontWeight:'900',fontSize:13,marginBottom:7},profileText:{color:'#b8bcbd',fontSize:12,lineHeight:18},actionList:{borderWidth:1,borderColor:'#555b5d',backgroundColor:'rgba(14,16,17,.98)',borderRadius:7,overflow:'hidden',marginBottom:12},actionRow:{height:58,flexDirection:'row',alignItems:'center',paddingHorizontal:14,borderBottomWidth:1,borderBottomColor:'#34393b'},actionIcon:{color:'#f4f4f0',fontSize:24,width:34},actionText:{color:'#f4f4f0',fontWeight:'800',fontSize:13,flex:1},actionChevron:{color:'#ffb300',fontSize:27},safetyCard:{flexDirection:'row',gap:14,borderWidth:1,borderColor:'#555b5d',backgroundColor:'rgba(14,16,17,.98)',borderRadius:7,padding:16,marginTop:4},safetyShield:{width:48,height:56,borderWidth:2,borderColor:'#ffb300',borderRadius:20,alignItems:'center',justifyContent:'center'},safetyShieldText:{color:'#ffb300',fontSize:22,fontWeight:'900'},redText:{color:'#ff6b6b',fontWeight:'900'},backCard:{height:56,flexDirection:'row',alignItems:'center',borderWidth:1,borderColor:'#555b5d',backgroundColor:'rgba(14,16,17,.98)',borderRadius:7,paddingHorizontal:14,marginTop:14}
});
